...
const carouselProjects: CarouselProject[] = [
  ...
  {
    id: 'brand11',
    videoUrl: '/videos/project-video-10.mp4',
    title: 'Ethereal Door Mystery',
    altText: 'Ethereal Door Mystery',
  },
  {
    id: 'brand12',
    videoUrl: '/videos/project-video-11.mp4',
    title: 'Outlaw in the Desert',
    altText: 'Outlaw in the Desert',
  },
  {
    id: 'brand13',
    videoUrl: '/videos/project-video-12.mp4',
    title: 'Promotion Video',
    altText: 'Promotion Video',
  },
  {
    id: 'brand14',
    videoUrl: '/videos/project-video-13.mp4',
    title: 'Avant Garde with Music',
    altText: 'Avant Garde with Music',
  },
  {
    id: 'brand15',
    videoUrl: '/videos/project-video-14.mp4',
    title: 'Avant Garde without Music',
    altText: 'Avant Garde without Music',
  },
  {
    id: 'brand16',
    videoUrl: '/videos/project-video-15.mp4',
    title: 'SnowWhite Animation',
    altText: 'SnowWhite Animation',
  },
  {
    id: 'brand17',
    videoUrl: '/videos/project-video-16.mp4',
    title: 'Mobile Video Concept',
    altText: 'Mobile Video Concept',
  },
  {
    id: 'brand7',
